...
u_char *ngx_http_v2_write_int(u_char *pos, ngx_uint_t prefix, ngx_uint_t value);

u_char *ngx_http_v2_write_header(ngx_http_v2_connection_t *h2c, u_char *pos,
    u_char *key, size_t key_len, u_char *value, size_t value_len,
    u_char *tmp);

#if (NGX_HTTP_V2_HPACK_ENC)
void ngx_http_v2_table_resize(ngx_http_v2_connection_t *h2c);
#endif
