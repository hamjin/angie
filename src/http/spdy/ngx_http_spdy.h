...
#define NGX_SPDY_PROTO_30             "spdy/3"
#define NGX_SPDY_PROTO_31             "spdy/3.1"
#define NGX_SPDY_ALPN_ADVERTISE       "\x08spdy/3.1\x06spdy/3"
#define NGX_SPDY_NPN_ADVERTISE        "\x08spdy/3.1\x06spdy/3"
...
ngx_int_t ngx_http_spdy_read_unbuffered_request_body(ngx_http_request_t *r);
